...
SRC_URI="
	...
	https://patch-diff.githubusercontent.com/raw/qtcreator-meson-plugin/qtcreator-meson-plugin/pull/7.patch -> ${P}-version-4.11.patch
...
PATCHES=( "${DISTDIR}/${P}-version-4.11.patch" )
